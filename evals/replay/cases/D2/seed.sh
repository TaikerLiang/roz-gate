#!/usr/bin/env bash
# D2 sandbox: in-flight issue with an open fidelity thread on the QA CR.
# feat/5 exists and MUST NOT be touched by the fidelity work — that is the
# case. qa/5 carries the acceptance test the thread criticizes.
set -eu
